...
CHECKPOINT_PATH = '/home/azamat.kaibaldiyev/Tasmania_ohara_labels/checkpoints_dems_16/'
...
import glob
import rasterio
dataset_path = 'Tasmania_ohara_labels/cropped_dems_16/'
dataset_path_with_labels = 'Tasmania_ohara_labels/cropped_dems_16_with_labels/'

class SwedishDataset(Dataset):
    def __init__(self,  transform  = None, dataset_path = None):
