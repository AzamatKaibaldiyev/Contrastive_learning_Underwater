...
CHECKPOINT_PATH = '/home/azamat.kaibaldiyev/Tasmania_ohara_labels/checkpoints_Ohara_images_and_bathym16_pairs_and_nonpairs/'
...
bathym =  sorted(glob.glob('Tasmania_ohara_labels/cropped_dems_16/*'))
print(len(bathym))
...
with open('files_remove_indices/Ohara_dems_and_images_137000_dem16_labels_train_set_indexes.npy', 'rb') as f:
    train_set_indexes = np.load(f)

with open('files_remove_indices/Ohara_dems_and_images_137000_dem16_labels_test_set_indexes.npy', 'rb') as f:
...
wandb.init(
    ...
    "learning_rate": lr,
    "architecture": "SimCLR",
    "dataset": "Ohara_dataset_dems_and_images_156000_demsize16_norm",
    "epochs": epochs,
    }
)
