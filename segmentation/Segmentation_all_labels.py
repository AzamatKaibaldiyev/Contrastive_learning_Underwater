...
class SwedishDataset(Dataset):
    ...
    def convert_to_classes(self, temp_tensor):
        mask_tensor_1 = (temp_tensor == 111)
        mask_tensor_11 = (temp_tensor == 112)
        mask_tensor_12 = (temp_tensor == 113)
        mask_tensor_13 = (temp_tensor == 114)
        mask_tensor_14 = (temp_tensor== 115)
        mask_tensor_15 = (temp_tensor == 116)
        mask_tensor_16 = (temp_tensor == 117) 

        mask_tensor_2 = (temp_tensor == 118)

        mask_tensor_3 = (temp_tensor == 121)
        mask_tensor_31 = (temp_tensor == 122)
        mask_tensor_32 = (temp_tensor == 123)
        mask_tensor_33 = (temp_tensor== 124)
        mask_tensor_34 = (temp_tensor == 125)
        mask_tensor_35 = (temp_tensor == 126)
        mask_tensor_36 = (temp_tensor == 127)

        mask_tensor_4 = (temp_tensor == 128)
        mask_tensor_5 = (temp_tensor == 2)
        mask_tensor_6 = (temp_tensor == 3)
        mask_tensor_7 = (temp_tensor == 41)
        mask_tensor_71 = (temp_tensor== 42)

        mask_tensor_8 = (temp_tensor == 51)
        mask_tensor_81 =(temp_tensor == 52)
        mask_tensor_82 =(temp_tensor == 53)

        mask_tensor_9 = (temp_tensor == 61)
        mask_tensor_91 = (temp_tensor == 62)

        mask_tensor_outside = (temp_tensor==0)
        mask_tensors = [mask_tensor_1,mask_tensor_11,mask_tensor_12,mask_tensor_13,mask_tensor_14,mask_tensor_15,mask_tensor_16,
                      mask_tensor_2,
                      mask_tensor_3,mask_tensor_31,mask_tensor_32,mask_tensor_33,mask_tensor_34,mask_tensor_35,mask_tensor_36,
                      mask_tensor_4,
                      mask_tensor_5,
                      mask_tensor_6, 
                      mask_tensor_7,mask_tensor_71,
                      mask_tensor_8,mask_tensor_81,mask_tensor_82,
                      mask_tensor_9, mask_tensor_91, 
                      mask_tensor_outside]
        temp_image = temp_tensor
...
from torch.utils.data import random_split
import math
dataset = SwedishDataset(transform = data_transforms, remove_list = images_containing_nine)
#train_data, test_data = random_split(dataset, [math.ceil(len(dataset)*0.8), math.floor(len(dataset)*0.2)])
train_size = math.ceil(len(dataset)*0.9)
test_size = math.floor(len(dataset)*0.1)
train_dataset = torch.utils.data.Subset(dataset, range(train_size))
...
model_name = "SwedenData/checkpoints/U-Net_normranged_normalized_smalldata_1000epoch_all_labels.pth"
