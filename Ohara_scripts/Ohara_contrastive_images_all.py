...
with open('files_remove_indices/Ohara_images_36000_train_set_indexes.npy', 'rb') as f:
    train_set_indexes = np.load(f)

with open('files_remove_indices/Ohara_images_36000_test_set_indexes.npy', 'rb') as f:
