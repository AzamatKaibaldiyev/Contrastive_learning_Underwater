...
df_merged_images['Left image name'] = 'Tasmania_ohara_labels/Ohara_all_images_labels/image_labels/'+df_merged_images['Left image name']
...
import glob
import rasterio
dataset_path = 'Tasmania_ohara_labels/Ohara_all_images_labels/image_labels/'
...
wandb.init(
    ...
    "learning_rate": lr,
    "architecture": "SimCLR",
    "dataset": "Ohara_dataset_images_11000",
    "epochs": epochs,
    }
)
